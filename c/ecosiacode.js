...
setTimeout(function() {
  ...
  $(document).ready(function() {
    ...
    function usernamelol(name) {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          // Display Players
          gahviplay = json.count
          gap = json.count
          //$('#gahviplayerslol').html(json.body.userData.fans)
          readygap = readygap + "11"
          gahviplayerslol.innerHTML = json.rate;
          pdiff.innerHTML = json.count;
        }
      });
    }
    ...
    setInterval(function() {
      ...
      if (ygs === "ya") {
        console.log("ya noob you did it :D")
        gahviplay = gahviplay + rat
        pdiff.innerHTML = gahviplay;
      }
